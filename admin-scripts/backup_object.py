...
parser.add_argument("-o", "--objectname", help="Object Which you want to download - It is Required Argument", required=True)


# parse and store all the user arguments into 'args' variable
args = parser.parse_args()

# Call the function to take given objects backup
IE.backup_object(args.appliance, args.domain, object_name=args.objectname, refobjects="on", reffiles="on")
