...
parser.add_argument("-o", "--object_name", help="MPGW service name or provide 'all' - It is Required Argument", required=True)
...
STATS.get_mpgw(appliance=args.appliance, domain=args.domain, object_name=args.object_name, sort_option=args.sort)
