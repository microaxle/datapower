...
parser.add_argument("-f", "--filepath", help="Datapower filepath to download. Give full path - Example 'local/subdirectory/filename'", required=True)
#parser.add_argument("-l", "--localpath", help="Local directory where you want to download'", required=True)


# parse and store all the user arguments into 'args' variable
args = parser.parse_args()

# Call the function to take backup of given file
FM.backup_file(args.appliance, args.domain, args.filepath)
